...
const AdvertiseTickets = () => {
    ...
    return (
        <div className='max-w-[1200px] min-h-[65vh] mx-auto pt-[50px]'>
            ...
            <div className='mb-[50px] mx-2 lg:mx-0 w-auto p-3 lg:p-5 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 bg-[#0A2F23] border-2 border-[#D9C296c0] rounded-2xl shadow-2xl shadow-[#0A2F2390] text-[#D9C296]'>
